...
class DisplinaryController extends Controller
{
    ...
    public function index(Request $request)
    {
     ...
     $btn = $btn .'<a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" id="deleteDisplinary" data-original-title="Delete" class="btn btn-primary btn-sm deleteDisplinary">Delete</a>';
