...
class EmpQualificationController extends Controller
{
    ...
    public function index(Request $request)
    {
     ...
     $btn = $btn .'<a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" id="deleteEmpQualification" data-original-title="Delete" class="btn btn-outline-danger btn-sm deleteEmpQualification">Delete</a>';
