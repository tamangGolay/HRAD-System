  ...
  public function Director_hrservice(Request $request)
  {
    ...
    switch ($request->status) {
        case 'Recommended':
            ...
            $mailData['body1'] = "You have a request for <b>$noteTitle</b> recommended by the director {$userDetail->empName} bearing employee Id {$userDetail->empId} of {$userDetail->officeDetails}. Your request will now be reviewed by the next-in-line supervisor.";
        ...
        case 'Approved':
            $mailData['body1'] = "Your request for <b>$noteTitle</b> has been approved by the director {$userDetail->empName} bearing employee Id {$userDetail->empId} of {$userDetail->officeDetails}. Now the HR focal will review your request and will contact you soon.";
