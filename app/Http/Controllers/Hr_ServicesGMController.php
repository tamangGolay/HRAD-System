  ...
  public function GM_hrservice(Request $request)
  {
    ...
    switch ($request->status) {
        case 'Recommended':
            ...
            $mailData['body1'] = "You have a request for <b>$noteTitle</b> recommended by the general manager {$userDetail->empName} bearing employee Id {$userDetail->empId} of {$userDetail->longOfficeName}.";
        ...
        case 'Approved':
            $mailData['body1'] = "Your request for <b>$noteTitle</b> has been approved by the general manager {$userDetail->empName} bearing employee Id {$userDetail->empId} of {$userDetail->longOfficeName}.";
        ...
        case 'Rejected':
            ...
            $mailData['body1'] = "Your request for <b>$noteTitle</b> has been rejected by the general manager {$userDetail->empName} bearing employee Id {$userDetail->empId} of {$userDetail->longOfficeName}.";
