  ...
  public function Manager_hrservice(Request $request)
  {
    ...
    switch ($request->status) {
        case 'Recommended':
            ...
            $mailData['body1'] = "You have a request for <b>$noteTitle</b> recommended by the manager {$userDetail->empName} bearing employee Id {$userDetail->empId} of {$userDetail->officeDetails}.";
        ...
        case 'Approved':
            $mailData['body1'] = "Your request for <b>$noteTitle</b> has been approved by the manager {$userDetail->empName} bearing employee Id {$userDetail->empId} of {$userDetail->officeDetails}.";
