...
// try{
    ...
    if($request->status == "Recommended" ){  //&& $request->remarks != ''
        ...
        ->first();   
           ...
           $users = new promotionRequest;//promotionRequest is ModelName
            $users->id = $id->id;//emp_id is from input name
            $users->promotionYear =  $request->promotionYear;//EmpName is from dB
            $users->promotionMonth =  $request->promotionMonth;
            $users->empId =  $request->empId;
            $users->fromGrade =  $request->fromGrade;
            $users->toGrade =  $request->toGrade;
            $users->oldBasic =  $request->oldBasic;
            $users->newBasic =  $request->newBasic;
            $users->office =  $request->office;
            $users->rejectReason = $request->remarks;
            $users->status = $request->status;//emp_id is from input name
            $users->save();
