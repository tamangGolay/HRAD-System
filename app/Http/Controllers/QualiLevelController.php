...
{ 
    ...
    public function index(Request $request)
    {
     ...
     $btn = $btn .'<a href="javascript:void(0)" data-toggle="tooltip"  data-id="'.$row->id.'" id="deleteQualilevel" data-original-title="Delete" class="btn btn-outline-danger btn-sm deleteQualilevel">Delete</a>';
