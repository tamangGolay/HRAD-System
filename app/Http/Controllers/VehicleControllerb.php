...
class VehicleController extends Controller
{
        ...
        try
         {
            ...
            $supervisior = ['title' => 'Mail From the BPC System', 'body' => 'Dear sir/madam,', 'body1' => 'You have a request for vehicle requisition from ' . $request->name . ' bearing employee Id ' . $request->emp_id . ' of ' . $org_unit_id->description . '.', 'body2' => '', 'body3' => 'Please kindly do the necessary action.', 'body4' => 'click here: bose.bpc.bt','body5' => '','body6' => '', ];
            ...
            {
                Mail::to('bosetry123@gmail.com')  //namgaywangchuk@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com') //ktobgye@bpc.bt
                    ->send(new MyTestMail($supervisior));
            ...
            if ($org_unit_id->org_unit_id == 54)
            {
                ...
                Mail::to('bosetry123@gmail.com')  //shamsherpradhan@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com') //drukchudorji@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com') //chadorphuntsho@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com')  //rinchenwangdi@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com')   //chhewangrinzin@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com')  //nim.dorji@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com')  //gorabdorji@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com')  //dechecholing@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com') //thinleygyeltshen@bpc.bt
                    ->send(new MyTestMail($supervisior));
                Mail::to('bosebackup1@gmail.com')
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com')  //sandeeprai@bpc.bt
                    ->send(new MyTestMail($supervisior));
            ...
            if ($org_unit_id->org_unit_id == 14 || $org_unit_id->org_unit_id == 16 || $org_unit_id->org_unit_id == 15 || $org_unit_id->org_unit_id == 65 || $org_unit_id->org_unit_id == 36 || $org_unit_id->org_unit_id == 40)
            {
                ...
                Mail::to('bosetry123@gmail.com')  //sangaytenzin1@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com') //kinleydem04@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com')  //dechendema@bpc.bt
                    ->send(new MyTestMail($supervisior));
                 Mail::to('bosebackup1@gmail.com')
                    ->send(new MyTestMail($supervisior));
            }
...

            {
                ...
                Mail::to('bosetry123@gmail.com') // sherub@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com') //gempojampel@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

            {
                ...
                Mail::to('bosetry123@gmail.com') //stobjey@bpc.bt
                    ->send(new MyTestMail($supervisior));
...

    {
        ...
        $mto = ['title' => 'Mail From the BPC System', 'body' => 'Dear sir/madam,', 'body1' => 'You have a request for vehicle requisition from ' . $name->vname . ' bearing employee Id ' . $emp_id->emp_id . ' of  ' . $org_unit_id->description . '.', 'body2' => '', 'body3' => 'Please kindly do the necessary action.', 'body4' => 'click here: bose.bpc.bt','body5' => '','body6' => '', ];

        Mail::to('bosetry123@gmail.com') //jigmephuntsho@bpc.bt
