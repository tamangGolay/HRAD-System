...
<script>
    ...
    $.ajax({
        ...
        //     msgBox.text(response.success ? 'You have approved the request successfully!' : 'Failed to update status.')
...
$(document).on('click', '.reject-btn', function() {
    ...
    $.ajax({
        ...
        //     success: function(response) {
        //     const msgBox = $('#statusMessage');
        //     msgBox.text(response.success ? 'You have rejected the request!' : 'Failed to update status.')
        //         .show().delay(3000).fadeOut();
