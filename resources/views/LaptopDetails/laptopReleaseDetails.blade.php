 ...
 <div class="row">	
	<div class="col-md-12">
		...
		<!-- <div class="card card-outline"> -->
			<div class="releaseDetails card-header bg-green  d-flex justify-content-center"> <strong>Laptop Release Details</strong> </div>
			<!--/card-header-->
			<div class="textfont card-body">

				<form method="POST" action="{{ route('Laptop_release') }}" enctype="multipart/form-data" accept-charset="UTF-8"> @csrf
                ...
                <label class="col-md-4 col-form-label text-md-right" for="nameid">&nbsp;&nbsp;&nbsp;Name:</label>
					...
					<div class="form-group row">
						<label class="col-md-4 col-form-label text-md-right" for="purpose">&nbsp;&nbsp;&nbsp;Remarks:</label>
						<div class="col-sm-10 col-md-6 col-lg-4">
						<!-- <input type="text" class="form-control" name="refundAmount" autocomplete="off" placeholder="Eg:10,000" id="refundAmount" required>  -->
					...
					<div class="form-group row mb-0">
						<div class="col text-center col-form-label col-md-center col-sm-2 col-md-10 col-lg-12 ">
							<button type="submit"  id="book" class="btn btn-outline-success btn-lg">Release</button>
						</div>
					</div>
				</form>
