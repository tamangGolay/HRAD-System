<div class="row ">
	...
	<form method="POST" action="/toDirReviewTransfer" enctype="multipart/form-data"  accept-charset="UTF-8" > @csrf
     ...
     <input type="hidden" class="form-control" value="{{ Auth::user()->empId }}" name="empId" id="empId" >
		...
		<div class="card-body table-responsive p-0">
					<table id="table1" class="table table-hover table-striped table-bordered" style="width:95%;">
						...
						<tbody>
						 @foreach($toDirtransferrequest as $rv)
						<tr>
