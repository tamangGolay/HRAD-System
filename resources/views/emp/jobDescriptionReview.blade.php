					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="Form" name="Form" class="form-horizontal"> @csrf
								...
								<input type="hidden" value="<?php echo $userdetails[0]->id;?>" name="id" id="id" >
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
									<input type="text" value="<?php echo $userdetails[0]->empId; ?>" name="emp_id" id="emp_id" >
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
									<input type="text" value="<?php echo $userdetails[0]->empName; ?>" name="empName" id="empName" >
						...
						<div class="col-sm-6">
							...
							<select class="form-control" name="office" id="office" required> @foreach($userdetails as $userdetails)
								<option value="{{$userdetails->id}}" > {{$userdetails->longOfficeName}}
								</option>
								@endforeach </select>
						</div>
					</div>
