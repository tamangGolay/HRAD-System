		...
		<section class="content" id='FR'>
				...
				<div class="row">
					<div class="col-lg-4 col-6">
						...
						<div class="small-box bg-info">
							<div class="inner">
								<h2><a href="/starter" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                     FR Deployment<h2>
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
              </div>
              <a href="/starter" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="{{url('/starter')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
