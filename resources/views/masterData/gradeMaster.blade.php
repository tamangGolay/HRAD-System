...
<div class="container">
    <a class="btn success" href="javascript:void(0)" id="manageGrade">Add new Grade&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"> </i></a>
                ...
                <input type="hidden"  value="{{ csrf_token() }}">
                   ...
                   <input type="hidden" name="id" id="grade_id">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">Grade_Name</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="name" name="grade" placeholder="Enter your grade name" value="" maxlength="50" required>
                        </div>
                    </div>
     
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Grade_Level</label>
                        <div class="col-sm-12">
                            <input type="text" id="number" name="level"  placeholder="Enter your grade level" class="form-control" required>
                        </div>
                    </div>
      
                    <div class="col-sm-offset-2 col-sm-10">
                     <button type="submit"  class="btn btn-primary" id="gradeButton" value="create">Save changes
                     </button>
...
<script type="text/javascript">
    ...
    $('#manageGrade').click(function () {    //manange vehicle
        ...
        $('#grade_id').val('');
        $('#Form').trigger("reset");
        $('#modelHeading').html("Add new grade");   // model heading
  ...
  //  After clicking the edit button it will trigger here
    $('body').on('click', '.edit', function () {
      ...
      $.get("{{ route('grade.index') }}" +'/' + grade_id +'/edit', function (data) {
...
//   After clicking save changes in Add and Edit it will trigger here
    ...
    $('#gradeButton').click(function (e) {  //after clicking save changes
        ...
        $.ajax({
          data: $('#Form').serialize(),
          url: "{{ route('grade.store') }}",    // grade-route
          type: "POST",
          dataType: 'json',
