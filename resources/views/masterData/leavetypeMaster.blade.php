...
<div class="container">
    <a class="btn success" href="javascript:void(0)" id="manageLeave">Add new Leave type&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"> </i></a>
    <table class="table table-bordered data-table"style="width:100%" style="width:100%">
    @csrf
        <thead>
            <tr>
                <th>No</th>
...
<div class="modal fade" id="leaveModel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="leaveHeading"></h4>
            </div>
            <div class="modal-body">
                <form id="Form" name="Form" class="form-horizontal">
                @csrf
                ...
                <div class="col text-center col-form-label col-md-center col-sm-2 col-md-10 col-lg-12">
                    <button type="submit" class="btn btn-outline-success" id="leaveDeleteButton" value="create">Yes</button>
...
<script type="text/javascript">
    ...
    $('#manageLeave').click(function () {
        $('#leaveButton').val("create-room");
        $('#leave_id').val('');
        $('#Form').trigger("reset");
        $('#modelHeading').html("Add Leave Type");
  ...
  //  After clicking the edit button it will trigger here
    $('body').on('click', '.edit', function () {
      ...
      $.get("{{ route('leave.index') }}" +'/' + leave_id +'/edit', function (data) {
          $('#modelHeading').html("Edit Leave Type");
          $('#leaveButton').val("edit-room");
          $('#ajaxModel').modal('show');
          $('meta[name="csrf-token"]').attr('content'),
          $('#leave_id').val(data.id);
          $('#leaveType').val(data.leaveType); //input id,database
...
//   After clicking save changes in Add and Edit it will trigger here
    ...
    $('#leaveButton').click(function (e) {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            $.get('/getView?v=leavetypemaster',function(data){
            $('#contentpage').empty();                          
  ...
  //  After clicking delete it will trigger here
    ...
    $('body').on('click', '.deleteLeave', function () {
      ...
      $.get("{{ route('leave.index') }}" +'/' + leave_id +'/edit', function (data) {
          $('#leaveHeading').html("Do you want to delete ?");
          $('#leaveDeleteButton').val("edit-room");
  ...
  // after clicking yes in delete
    $('#leaveDeleteButton').click(function (e) {
        ...
        var alt = document.createElement("div");
          ...
          error: function (data) {
              console.log('Error:', data);
              $('#leaveDeleteButton').html('Save Changes');
          }
      });
    });
