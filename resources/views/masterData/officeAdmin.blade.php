...
<div class="container">
    <a class="btn success" href="javascript:void(0)" id="manageOfficeAdmin">Add OfficeAdmin &nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"> </i></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden"  value="{{ csrf_token() }}">
                   ...
                   <input type="hidden" name="id" id="officeAdmin_id">
                    ...
                    <div class="form-group">
                        ...
                        <!-- <select class="col-lg-12 col-sm-12" name="officeName" id="officeName" value="" required>
                                             ...
                                             @foreach($off as $off)
                                             <option value="{{$off->id}}">{{$off->officeName}}</option>
										@endforeach
							</select> -->
                    ...
                    <div class="form-group">
                        <label class="col-lg-12 col-sm-12 control-label">Office Admin</label>
                        <div class="col-lg-12 col-sm-12">
                        <input type="text" id="officeAdmin" name="officeAdmin"  placeholder="eg: 30003093" class="form-control" required> 
                         </div> 
                    </div>
...
<div class="modal fade" id="officeAdminModel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="officeAdminHeading"></h4>
            </div>
            <div class="modal-body">
                <form id="Form" name="Form" class="form-horizontal">
                @csrf
                ...
                <div class="col text-center col-form-label col-md-center col-sm-2 col-md-10 col-lg-12">
                    <button type="submit" class="btn btn-outline-success" id="officeAdminDeleteButton" value="create">Yes</button>
...
<script type="text/javascript">
    ...
    $('#manageOfficeAdmin').click(function () {
  ...
  //  After clicking the edit button it will trigger here
    $('body').on('click', '.edit', function () {
      var officeAdmin_id = $(this).data('id');
     
      $.get("{{ route('officeAdmin.index') }}" +'/' + officeAdmin_id +'/edit', function (data) {
          $('#modelHeading').html("Edit Office details");
          $('#officeButton').val("edit-room");
          $('#ajaxModel').modal('show');
          $('meta[name="csrf-token"]').attr('content'),
          $('#officeAdmin_id').val(data.id);
...
//   After clicking save changes in Add and Edit it will trigger here
  ...
  //  After clicking delete it will trigger here
    ...
    $('body').on('click', '.deleteOffice', function () {
      ...
      $.get("{{ route('officeAdmin.index') }}" +'/' + officeAdmin_id +'/edit', function (data) {
          $('#officeAdminHeading').html("Do you want to delete this office Admin?");
          $('#officeAdminDeleteButton').val("edit-room");
          $('#officeAdminModel').modal('show');
          $('meta[name="csrf-token"]').attr('content'),
          $('#officeAdmin_id').val(data.id);
  ...
  // after clicking yes in delete
    $('#officeAdminDeleteButton').click(function (e) {
        e.preventDefault();
        $(this).html('Save');
        ...
        var alt = document.createElement("div");
          ...
          error: function (data) {
              console.log('Error:', data);
              $('#officeAdminDeleteButton').html('Save Changes');
          }
      });
    });
