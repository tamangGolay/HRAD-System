            ...
            <div class="modal-body">
                ...
                <input type="hidden"  value="{{ csrf_token() }}">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="placeName" name="placeName" value=""  required>
                        </div>
                    </div><div class="form-group">
                        <label for="name" class="col-sm-2 control-label">Drungkhag</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="drungkhag" name="drungkhag" value=""  required>
                        </div>
                    </div><div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <select name="gewogName" id="gewogName" value="" required>
...
<script type="text/javascript">
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'placeName', name: 'placeName', orderable: false, searchable: true},
            {data: 'drungkhag', name: 'drungkhag', orderable: false, searchable: false},
            {data: 'village', name: 'village', orderable: false, searchable: false},
            {data: 'gewogName', name: 'gewogName', orderable: false, searchable: false},
  ...
  //  After clicking the edit button it will trigger here
    $('body').on('click', '.editplace', function () {
      ...
      $.get("{{ route('place.index') }}" +'/' + place_id +'/edit', function (data) {
          ...
          $('#placeName').val(data.placeName); //input id,database
          $('#drungkhag').val(data.drungkhag);//keeping input name and dB field name same so that the search will not give error
          $('#village').val(data.village);//keeping input name and dB field name same so that the search will not give error
          $('#gewogName').val(data.gewogName);//keeping input name and dB field name same so that the search will not give error
