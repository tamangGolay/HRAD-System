                ...
                <input type="hidden"  value="{{ csrf_token() }}">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-sm-2 control-label">Substation_Head</label>
                        <div class="col-sm-12">
