      ...
      <div class="card ">
       <div class="card-header bg-green">     
            <div class="col text-center">
              <h5>
                <b>DCSD Vehicle Review</b>
              </h5>    
            </div>
        </div>
        <!--/card-header-->
      
      <form method="POST" action="/vehicleapprove" enctype="multipart/form-data" accept-charset="UTF-8">
        ...
        <input type="hidden" name="token" id="tokenid" value="{{ csrf_token()}}">
          ...
          <div class="card-body table-responsive p-0">    
                ...
                <table id="table6" class="table table-hover table-striped table-bordered">
                  <thead>
                  ...
                  <td>                   
                   ...
                   <button type="submit" name="id[]" id="id" value="{{$rv->id}}"class=" button1 btn btn-outline-success text-center text-dark">Approve</button> &nbsp;&nbsp;
                  </td>
                 
                   </form>
                   <td>

                   <form method="POST" action="/vehiclereject" enctype="multipart/form-data" accept-charset="UTF-8">

          @csrf
        <input type="hidden" name="token" id="tokenid" value="{{ csrf_token()}}">
                      <button type="submit" name="id[]" id="id" value="{{$rv->id}}" class="button2 btn btn-outline-danger text-center text-dark"> Reject
                        </button>
                          <br><br>
                        <div>
                 <textarea name="reason" id="reason" placeholder="reason for rejection" style="margin-left:5%" required>
                </textarea>                
                </div>    
