		...
		<div class="card ">
			<div class="card-header bg-green">
				<div class="col text-center">
					<h5>
                <b>Distribution Services Vehicle Review</b>
              </h5> </div>
			</div>
			<!--/card-header-->
			<form method="POST" action="/vehicleapprove" enctype="multipart/form-data" accept-charset="UTF-8"> @csrf
				...
				<div class="card-body table-responsive p-0">
					<table id="table8" class="table table-hover table-striped table-bordered">
						<thead>
			...
			<div class="float-right"> {{$dsReview->links()}} </div>
			<div>
				<!--/card-body-->
				</form>
			</div>
