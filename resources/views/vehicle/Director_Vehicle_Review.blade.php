    ...
    <div class="col">
        <div class="card">
            <div class="card-header bg-green text-center">
                <h5><b>Vehicle Review By Director</b></h5>
            </div>

            <div class="card-body table-responsive p-0">
                <table id="Director_table" class="table table-hover table-striped table-bordered">
                    <thead>
                    ...
                    <tbody>
                        @foreach($Director_Vehicle_Review as $rv)
                        <tr>
                            <td>{{ $rv->id }}</td>
                            <td>{{ $rv->emp_id }}</td>
                ...
                <div class="float-right">{{ $Director_Vehicle_Review->links() }}</div>
            </div>
        </div>
    </div>
</div>
