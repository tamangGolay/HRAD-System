		...
		<div class="card ">
			<div class="card-header bg-green">
				<div class="col text-center">
					<h5>
                <b>Finances & Account Services Vehicle Review</b>
              </h5> </div>
			</div>
			<!--/card-header-->
			<form method="POST" action="/vehicleapprove" enctype="multipart/form-data" accept-charset="UTF-8"> @csrf
				...
				<div class="card-body table-responsive p-0">
					<table id="table10" class="table table-hover table-striped table-bordered">
						<thead>
			...
			<form method="POST" action="/vehiclereject" enctype="multipart/form-data" accept-charset="UTF-8"> @csrf
				...
				<button type="submit" name="id[]" id="id" value="{{$rv->id}}" class=" button2 btn btn-outline-danger text-center text-dark">
				 Reject</button>
					 <br>
					 <br>
				<div>
			...
			<div class="float-right"> {{$fasReview->links()}} </div>
			<div>
				<!--/card-body-->
				</form>
			</div>
