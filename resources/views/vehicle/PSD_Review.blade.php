		...
		<div class="card ">
			...
			<form method="POST" action="/vehicleapprove" enctype="multipart/form-data" accept-charset="UTF-8"> @csrf
				...
				<div class="card-body table-responsive p-0">
					<table id="table15" class="table table-hover table-striped table-bordered">
						<thead>
						...
						<tbody> @foreach($psdReview as $rv)
							<tr>
								...
								<td>
									...
									<button type="submit" name="id[]" id="id" value="{{$rv->id}}" class=" button1 btn btn-outline-success text-center text-dark">
									Approve</button> &nbsp;&nbsp; </td>
		 ...
		 <td>
			...
			<div class="float-right"> {{$psdReview->links()}} </div>
			<div>
				<!--/card-body-->
				</form>
			</div>
