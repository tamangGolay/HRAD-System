		...
		<div class="card ">
			<div class="card-header bg-green">
				<div class="col text-center">
					<h5>
                <b>Transmission Services Vehicle Review</b>
              </h5> </div>
			</div>
			<!--/card-header-->
			<form method="POST" action="/vehicleapprove" enctype="multipart/form-data" accept-charset="UTF-8"> @csrf
				...
				<div class="card-body table-responsive p-0">
					<table id="table19" class="table table-hover table-striped table-bordered">
						<thead>
						...
						<tbody> @foreach($tsReview as $rv)
							...
							<td> {{$rv->id}} </td>
								...
								<td style="width:40%">
									...
									<button type="submit" name="id[]" id="id" value="{{$rv->id}}" class="button1 btn btn-outline-success text-center text-dark"> Approve
										 </button> &nbsp;&nbsp; </td>
		 ...
		 <td>
			...
			<div class="float-right"> {{$tsReview->links()}} </div>
			<div>
				<!--/card-body-->
				</form>
			</div>
