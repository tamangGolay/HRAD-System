		...
		<div class="card ">
			<div class="card-header bg-green">
				<div class="col text-center">
					<h5>
                <b> MTOs' GM/PID review</b>
              </h5> </div>
			</div>
			<!--/card-header-->
			<form method="POST" action="/MTOGMapprove" enctype="multipart/form-data" accept-charset="UTF-8"> @csrf
			...
			<div class="float-right"> {{$mtoGM->links()}} </div>
			<div>
				<!--/card-body-->
				</form>
			</div>
