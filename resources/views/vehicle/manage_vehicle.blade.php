                ...
                <input type="hidden"  value="{{ csrf_token() }}">
                   ...
                   <input type="hidden" name="id" id="vehicle_id">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Toyota Hilux (BG-2-A0590)" value="" maxlength="50" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" id="number" name="number"  placeholder="Vehicle number" class="form-control" required>
                        </div>
                    </div>
