...
<div class = "col-md-11 text-center">
 ...
 <div class="col text-right col-form-label col-md-right col-sm-4 col-md-6 col-lg-11 ">
<button class="btn btn-outline-info btn" onclick="checkofficeId();" style="color:black;"><strong>Click here to check your office Id<strong></button>
	</div
...
{
 $.get('tocheckofficeId',function(data){ 
    $('#contentpage').empty();                  
