                ...
                <div class = "row">
                    <div class = "col-md-12">
                        <div class="card-body table-responsive p-0">
                           <!-- <a href=""><button onclick="backbutton()";>Go Back </button></a> -->

                           <button class="btn" onclick="backbutton();" style="color:black;"><i class="fa fa-arrow-left  fa-lg" aria-hidden="true"></i>Previous Page</button>
					        ...
					        <table id="table5" class="table table-hover table-striped table-bordered">
                               <thead>
                                <tr class="text-nowrap">
                                    ...
                                    <th scope = "col" class="col1"> Office Name</th>
                                    

                                </tr>
                               </thead>
                               <tbody>
                                @foreach ($tocheckofficeId as $tocheckofficeId)
                                <tr>
                                    <td class="col1"> {{$tocheckofficeId->id}} </td>
                                    <td class="col1"> {{$tocheckofficeId-> officeDetails}} </td>
                                </tr>
                                @endforeach
                               </tbody>
                            </table>
